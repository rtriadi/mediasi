    ...
    <div class="max-w-lg w-full z-10">
        ...
        <div class="bg-slate-900/90 backdrop-blur-xl border border-slate-800 rounded-3xl p-6 sm:p-8 shadow-2xl shadow-rose-950/20 text-center relative overflow-hidden">
            ...
            <div class="w-16 h-16 sm:w-20 sm:h-20 bg-rose-500/10 border border-rose-500/20 rounded-2xl flex items-center justify-center mx-auto mb-6 shadow-inner shadow-rose-500/10">
                <i class="fa-solid fa-shield-halved text-rose-500 text-3xl sm:text-4xl"></i>
            </div>
            ...
            <!-- Message Body -->
            <div class="bg-slate-950/60 border border-slate-800/80 rounded-2xl p-4 sm:p-5 mb-6 text-sm text-slate-300 leading-relaxed text-left">
                <div class="flex items-start gap-3">
                    <i class="fa-solid fa-circle-exclamation text-rose-400 text-lg mt-0.5 flex-shrink-0"></i>
                    <div class="space-y-1 overflow-x-auto text-xs sm:text-sm">
                        <?= $message ?>
                    </div>
                </div>
            </div>
